...
*** Setting html-head
#+NAME: html-head
#+BEGIN_SRC raw :tangle no :noweb yes
  ...
  <link rel=\"icon\" href=\"data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 448 512' fill='gray'><path d='M96 0C43 0 0 43 0 96V416c0 53 43 96 96 96H384h32c17.7 0 32-14.3 32-32s-14.3-32-32-32V384c17.7 0 32-14.3 32-32V32c0-17.7-14.3-32-32-32H384 96zm0 384H352v64H96c-17.7 0-32-14.3-32-32s14.3-32 32-32zm32-240c0-8.8 7.2-16 16-16H336c8.8 0 16 7.2 16 16s-7.2 16-16 16H144c-8.8 0-16-7.2-16-16zm16 48H336c8.8 0 16 7.2 16 16s-7.2 16-16 16H144c-8.8 0-16-7.2-16-16s7.2-16 16-16z'/></svg>\">
...
#+BEGIN_SRC emacs-lisp :noweb yes
        ...
        (add-to-list
         ...
         `("html-documentation"
           ...
           :exclude "footnotes.org\\|toc.org\\|macro"
           :recursive nil
           :section-numbers 3
           :with-toc        2
           :time-stamp-file nil
...
#+BEGIN_SRC sh :results output :tangle no
  (
      ...
      if [ -d .svn ]; then
          ...
          log=$(LC_MESSAGES=en git --no-pager log -1 HEAD --date=short --pretty=format:"{\scriptsize\faIcon{$icon}} \ttfamily commit\href{$url/commit/%H}{\color{gray}\texttt{%h}} - %ad")
      fi
...
#+BEGIN_SRC emacs-lisp
  (add-to-list
   ...
   `("pdf-documentation"
     ...
     :exclude "footnotes.org\\|toc.org\\|README.org"
     :recursive nil
     :section-numbers 2
     :with-toc        t
